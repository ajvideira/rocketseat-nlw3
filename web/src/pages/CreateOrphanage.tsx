...
export default function CreateOrphanage() {
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    console.log({
      name, about, instructions, openingHours, openOnWeekends, latitude, longitude, images
    });
  ...
  function handleFiles(event: ChangeEvent<HTMLInputElement>) {
    ...
    const previewImages = selectedImages.map(file => URL.createObjectURL(file));
        ...
        <form className="create-orphanage-form">
          <fieldset>
            ...
            <div className="input-block">
              ...
              <input multiple type="file" onChange={handleFiles} id="images[]"/>
            </div>
